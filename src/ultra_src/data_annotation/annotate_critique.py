...
if __name__ == "__main__":
    ...
    for subset in subsets[:1]:
        ...
        dataset = datasets.Dataset.from_pandas(dataset) # just get the data in a hf dataset
